...
[![GoDoc](https://godoc.org/github.com/MegaGrindStone/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/MegaGrindStone/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/MegaGrindStone/btcwallet/walletdb

## Installation

```bash
$ go get github.com/MegaGrindStone/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/MegaGrindStone/btcwallet/walletdb#example-package--BasicUsage)  
