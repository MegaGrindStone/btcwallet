...
[![Build Status](https://travis-ci.org/MegaGrindStone/btcwallet.png?branch=master)](https://travis-ci.org/MegaGrindStone/btcwallet)
...
can be found [here](https://github.com/MegaGrindStone/btcd).  An alternative
...
https://github.com/MegaGrindStone/btcd/releases

https://github.com/MegaGrindStone/btcwallet/releases
...
```
git clone https://github.com/MegaGrindStone/btcwallet $GOPATH/src/github.com/MegaGrindStone/btcwallet
cd $GOPATH/src/github.com/MegaGrindStone/btcwallet
glide install
```
...
```bash
$ cp $GOPATH/src/github.com/MegaGrindStone/btcd/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/MegaGrindStone/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/MegaGrindStone/btcwallet/issues)
